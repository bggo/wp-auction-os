...
<div class="excerpt-thumb">
    <?php if (  true || (function_exists('has_post_thumbnail')) && (has_post_thumbnail())) : ?>
	    ...
	    <? $id = get_the_ID(); ?>
	    <img src="<?php echo get_post_meta($id, 'wdm_auction_thumb', true); ?>" width="100" height="80" alt="<?php the_title(); ?>" /> 
       		</a>
    <?php endif;?>
</div>
			<?php the_excerpt(); ?>
		...
		<span>Categoria: <?php the_category(' '); ?></span> <span><?php the_tags(); ?></span> 
